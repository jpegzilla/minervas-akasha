...
if (
  ...
  if (
    ('object' == typeof window
      ? (globalObject = window)
      : 'object' == typeof self && (globalObject = self),
    void 0 !== globalObject)
  )
    for (var i = 0; i < types.length; i++)
      globalObject[types[i]] &&
...
!(function(f) {
  var e = (function() {
    function e() {}
    return (
      (e.compressAsync = function(e, n, o) {
        var i = new f.Timer(),
          u = new f.Compressor()
      ...
      (e.createCompressionStream = function() {
        var o = new f.Compressor(),
          i = new (require('stream')).Transform({
            decodeStrings: !0,
            highWaterMark: 65536
          })
        return (
  ...
  (function(f) {
    var e = (function() {
      function e() {}
      return (
        (e.decompressAsync = function(e, n, o) {
          if (!o)
  ...
  (function(i) {
    ...
    ;((u = e = i.WebWorker || (i.WebWorker = {})).compressAsync = function(
      ...
      if ('ByteArray' != t.inputEncoding || e instanceof Uint8Array) {
        var n = {
          ...
          o = function(e) {
            ...
            t &&
              ...
              'error' == t.type ? r(void 0, new Error(t.error)) : r(t.data))
          }
      ...
      (u.createGlobalWorkerIfNeeded = function() {
        if (u.globalWorker) return !0
        if (!i.webWorkersAvailable()) return !1
        if (!u.scriptURI && 'object' == typeof document) {
          var e = document.getElementById('lzutf8')
          null != e && (u.scriptURI = e.getAttribute('src') || void 0)
        }
        return !!u.scriptURI && ((u.globalWorker = new Worker(u.scriptURI)), !0)
      }),
  ...
  (function(e) {
    var t
    ;((t = e.ArrayTools || (e.ArrayTools = {})).copyElements = function(
      e,
      t,
      r,
      n,
  ...
  (function(o) {
    ...
    ;((e =
      o.CompressionCommon ||
      (o.CompressionCommon = {})).getCroppedBuffer = function(e, t, r, n) {
      void 0 === n && (n = 0)
    ...
    ;(o.getRandomIntegerInRange = function(e, t) {
      ...
      (o.getRandomUTF16StringOfLength = function(e) {
        for (var t = '', r = 0; r < e; r++) {
          for (
            var n = void 0;
            55296 <= (n = o.getRandomIntegerInRange(0, 1114112)) && n <= 57343;
  ...
  (function(o) {
    var e = (function() {
      ...
      return (
        ...
        (e.prototype.logAndRestart = function(e, t) {
          void 0 === t && (t = !0)
          var r = this.getElapsedTime(),
            n = e + ': ' + r.toFixed(3) + 'ms'
          return o.log(n, t), this.restart(), r
        }),
        ...
        (e.createGlobalTimestampFunction = function() {
          if (
            'object' == typeof process &&
            'function' == typeof process.hrtime
          ) {
            var r = 0
            ;(this.timestampFunc = function() {
              ...
              (r = Date.now() - this.timestampFunc())
          } else if ('object' == typeof chrome && chrome.Interval) {
            var e = Date.now(),
              t = new chrome.Interval()
            t.start(),
              (this.timestampFunc = function() {
      ...
      return (
        ...
        (e.prototype.compressUtf8Block = function(e) {
          ...
          for (var o = (this.outputBufferPosition = 0), i = t; i < n; i++) {
            var u = r[i],
              s = i < o
            if (i > n - this.MinimumSequenceLength) s || this.outputRawByte(u)
            else {
              var a = this.getBucketIndexForPrefix(i)
              if (!s) {
                var c = this.findLongestMatch(i, a)
                null != c &&
              ...
              var f = this.inputBufferStreamOffset + i
        ...
        (e.prototype.cropAndAddNewBytesToInputBuffer = function(e) {
          ...
          return (
            (this.inputBuffer = n.CompressionCommon.getCroppedAndAppendedByteArray(
              this.inputBuffer,
              r,
              t,
              e
  ...
  (function(s) {
    var e = (function() {
      ...
      return (
        (e.prototype.addValueToBucket = function(e, t) {
          ;(e <<= 1),
          ...
          ;(this.bucketLocators[e] = n), (this.bucketLocators[e + 1] = r)
        }),
        (e.prototype.truncateBucketToNewerElements = function(e, t, r) {
          var n = e + t - r
          return (
        ...
        (e.prototype.compact = function() {
          ...
          for (r = 0; r < e.length; r += 2) {
            var o = e[r]
            if (0 !== o) {
              var i = this.bucketLocators[r],
                u = this.bucketLocators[r + 1]
              s.ArrayTools.copyElements(t, o, this.storage, i, u)
            }
          }
        }),
    ...
    var e = (function() {
      ...
      return (
        ...
        (e.prototype.getArraySegmentForBucketIndex = function(e, t) {
          ...
          return void 0 === r
            ? null
            : (void 0 === t && (t = new n.ArraySegment(r, 0, r.length)), t)
        }),
        (e.prototype.getUsedBucketCount = function() {
  ...
  (function(s) {
    ...
    ;(e = s.Encoding || (s.Encoding = {})),
      ...
      (t.decode = function(e) {
        return e
          ? s.runningInNodeJS()
            ? s.BufferTools.bufferToUint8Array(new Buffer(e, 'base64'))
            : t.decodeWithJS(e)
          : new Uint8Array(0)
      }),
  ...
  (function(s) {
    var e, t
    ;(e = s.Encoding || (s.Encoding = {})),
      ((t = e.BinaryString || (e.BinaryString = {})).encode = function(e) {
        if (null == e)
          throw new TypeError(
  ...
  (function(e) {
    ...
    ;(t = e.Encoding || (e.Encoding = {})),
      ((r = t.CodePoint || (t.CodePoint = {})).encodeFromString = function(
        e,
        t
      ) {
  ...
  (function(e) {
    var t, r, n
    ;(t = e.Encoding || (e.Encoding = {})),
      (r = t.DecimalString || (t.DecimalString = {})),
      (n = [
        '000',
        '001',
        '002',
  ...
  (function(a) {
    ...
    ;(i = a.Encoding || (a.Encoding = {})),
      ((t = i.UTF8 || (i.UTF8 = {})).encode = function(e) {
        return e && 0 != e.length
          ? a.runningInNodeJS()
            ? a.BufferTools.bufferToUint8Array(new Buffer(e, 'utf8'))
  ...
  (function(o) {
    ;(o.compress = function(e, t) {
      ...
      var n = new o.Compressor().compressBlock(e)
      return o.CompressionCommon.encodeCompressedBytes(n, t.outputEncoding)
    }),
      (o.decompress = function(e, t) {
        ...
        var r = o.CompressionCommon.decodeCompressedBytes(e, t.inputEncoding),
          n = new o.Decompressor().decompressBlock(r)
        return o.CompressionCommon.encodeDecompressedBytes(n, t.outputEncoding)
      }),
        ...
        ;(t = o.ObjectTools.override(
          ...
          o.enqueueImmediate(function() {
            t.useWebWorker && o.WebWorker.createGlobalWorkerIfNeeded()
              ? o.WebWorker.compressAsync(e, t, r)
              : o.AsyncCompressor.compressAsync(e, t, r)
          })
      }),
      (o.decompressAsync = function(e, t, r) {
        if ((null == r && (r = function() {}), null != e)) {
          ...
          r(
            void 0,
            new TypeError('decompressAsync: undefined or null input received')
          )
      }),
